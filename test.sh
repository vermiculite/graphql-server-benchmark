...
echo "Express Graphql"
curl -w "@curl-format.txt" -o /dev/null -s 'http://localhost:4000/' -H 'Content-Type: application/json' -H 'Accept: application/json' -H 'Connection: keep-alive' -H 'DNT: 1' -H 'Origin: http://localhost:5000' --data-binary '{"query":"{hello}"}' --compressed
